...
const Terms = () => (
  <div className="terms-container" style={{maxWidth: '700px', margin: '0 auto'}}>
    <pre style={{textAlign: 'left'}}>{`TERMS OF SERVICE AGREEMENT
    ...
    SERVICE AGREEMENT IS EFFECTIVE AS OF 08/06/2019.
    ...
    The Site is a non-profit website data search website which has the following description:
    ...
    Children under the age of 13 are not permitted to use this site. All accounts found to be used by children
    under the age of 13 will be terminated immediately.
    
    PRIVACY POLICY
    
    Every member's registration data and various other personal information are strictly protected by
    the Connect Our Kids LLC Online Privacy Policy (see the full Privacy Policy at
    https://search.connectourkids.org/privacy). As a member, you herein consent to the collection and
    ...
    Furthermore, you herein agree not to make use of Connect Our Kids LLC's Services for the
    purpose of:
