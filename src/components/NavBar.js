...
const LoggedInDropdown = ({ open, logout, user }) => {
  return (
    <div className={`nav__loggedInDropdown${open ? " open" : ""}`}>
      <ul>
        ...
        <li><a href="https://connectourkids.org/">connectourkids.org</a></li> 
  ...
  return (
    <div className={`nav__mobile-dropdown${open ? " open" : ""}`}>
      <ul>
        ...
        <li><a href="https://connectourkids.org/" onClick={() => setOpen(false)} >connectourkids.org</a></li>
